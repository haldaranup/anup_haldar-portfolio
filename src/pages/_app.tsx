...
function MyAppWithTheme(props: AppProps) {
  ...
  const theme = createMuiTheme({
    ...
    overrides: {
      MuiAppBar: {
        colorPrimary: {
          backgroundColor: paletteType === "dark" ? "#091c34" : "#d1f8ff",
  ...
  const renderDrawer: () => ReactNode = () => (
    ...
    >
      ...
      <List>
        ...
        <SideBarButton text="Tech Stack" name="skills">
          <BuildIcon />
        </SideBarButton>
  ...
  return (
    <>
      <Head>
        ...
        />
        {/* <title>Anup Haldar</title> */}
        {/* PWA primary color */}
        <meta name="theme-color" content="#161625" />
        {/* <!-- Primary Meta Tags --> */}
        <meta name="title" content="Anup Haldar" />
        <meta
          name="description"
          content="Hi, I am Anup Haldar, an adventurer in web development."
          key="description"
        />
        ...
        />
        <meta property="og:title" content="Anup Haldar" />
        <meta
        ...
        <meta
          ...
          content={`https://${process.env.NEXT_PUBLIC_VERCEL_URL}`}
        />
        <meta property="twitter:title" content="Anup Haldar" />
        <meta
      ...
      <AppBar component="nav">
        <Toolbar>
          ...
          <Typography
            ...
            // href="/#"
            variant="h6"
          ><Image src="/../public/favicon.png" height="40px" width="42px" /></Typography>
          {/* </Link> */}
          <div className={classes.navbarRight}>
            <Hidden mdDown>
              <Box mr={2}>
                ...
                {NavBarButton("Projects", "projects")}
